...
COMMON_SYSTEM_PROMPT = (
    ...
    "For edit_file, operation must be replace_text. "
    ...
    "Do not use restore_from_base; restoring registered base files would leak benchmark answers and is blocked by the verifier. "
